...
public class Scene {
    ...
    public File lightMapFile = null;
    public boolean rebuildLightMap = false;
    
    boolean calculateLightMap = true;
    ...
    public void calcBoundsAndTransform() {
        projection.identity().perspective((float)Math.toRadians(fovDegrees), Game.getInstance().getAspectRatio(), zNear, zFar);
